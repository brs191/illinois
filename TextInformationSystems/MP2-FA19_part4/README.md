...
**The evaluation results will be displayed on the leaderboard: [http://cs410-search.centralus.cloudapp.azure.com](http://cs410-search.centralus.cloudapp.azure.com)**
...
```
## Competition Tasks
For your code to be ranked in the leaderboard, you will need to follow the instructions in [GitLab_Competition_Instructions.pdf](GitLab_Competition_Instructions.pdf).
