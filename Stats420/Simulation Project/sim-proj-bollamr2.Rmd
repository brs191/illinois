...
y = beta_0 * x0 + beta_1 * x1 + beta_2 * x2 + beta_3 * x3 + eps
sim_data = data.frame(y, x1, x2, x3)

sim_data_lm_0 = lm(y ~ x1 + x2 + x3, data = sim_data)
summary(sim_data_lm_0)
# glance(sim_data_lm_0)$statistic
# glance(sim_data_lm_0)$p.value
# glance(sim_data_lm_0)$r.squared
names(glance(sim_data_lm_0))
glance(sim_data_lm_0)$df
summary(sim_data_lm_0)$fstatistic[2]
glance(sim_data_lm_0)$df.residual
summary(sim_data_lm_0)$fstatistic[3]

#simulation results
num_sims = 2000
f_stat = rep(0, num_sims)
...
#   
#   f_stat[i] = glance(sim_data_lm)$statistic
#   p_val[i] = glance(sim_data_lm)$p.value
#   r2[i] = glance(sim_data_lm)$r.squared
# }
# hist(f_stat, prob = TRUE, breaks = 20, xlab = "f-statistics", ylab = "value", main = "", border = "dodgerblue")
# curve(df(x, df1 = summary(sim_data_lm_0)$fstatistic[2], df2 = summary(sim_data_lm_0)$fstatistic[3]), col = "red", add = TRUE, lwd = 3)

# hist(p_val, prob = TRUE, breaks = 20, xlab = "p-value", ylab = "value", main = "", border = "dodgerblue")
# hist(r2, prob = TRUE, breaks = 20, xlab = "r squared", ylab = "value", main = "", border = "dodgerblue")
# 
# sig = 5
# for (i in 1:num_sims) {
#   eps = rnorm(25, mean = 0, sd = sig)
