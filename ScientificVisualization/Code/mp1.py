...
def getCellSegments(top,left,thres,cells):
    ...
    elif (key&8 == 0 and key&4 == 4): #01xx v1 == 1, v2 == 0
        v1 = cells[left, top]
        v2 = cells[left, top+1]
        t = interpolate(v1, v2, thres)
        lines.append((left, top+t))
        
    if (key&4 == 4 and key&2 == 0): #x10x v1 == 1, v2 == 0
        v1 = cells[left, top+1]
        v2 = cells[left+1, top+1]
        t = interpolate(v1, v2, thres)
    ...
    elif (key&2 == 0 and key&1 == 1): #xx01 v1 == 1, v2 == 0
        v2 = cells[left+1, top+1]
        v1 = cells[left+1, top]
        t = interpolate(v1, v2, thres)
        lines.append((left+1, top+t))
    ...
    elif (key&1 == 1 and key&8 == 0): #0xx1 v1 == 1, v2 == 0
        v1 = cells[left, top]
        v2 = cells[left+1, top]
        t = interpolate(v1, v2, thres)
        lines.append((left+t, top))
