...
# hist(f_stat_1, prob = TRUE, breaks = 20, xlab = "f-statistics for sigma 1", ylab = "value", main = "", border = "dodgerblue")
# hist(p_val_1, prob = TRUE, breaks = 20, xlab = "p-value for sigma 1", ylab = "value", main = "", border = "dodgerblue")
# hist(r2_1, prob = TRUE, breaks = 20, xlab = "r squared for sigma 1", ylab = "value", main = "", border = "dodgerblue")
...
# hist(f_stat_5, prob = TRUE, breaks = 20, xlab = "f-statistics for sigma 5", ylab = "value", main = "", border = "dodgerblue")
# hist(p_val_5, prob = TRUE, breaks = 20, xlab = "p-value for sigma 5", ylab = "value", main = "", border = "dodgerblue")
# hist(r2_5, prob = TRUE, breaks = 20, xlab = "r squared for sigma 5", ylab = "value", main = "", border = "dodgerblue")
...
# hist(f_stat_10, prob = TRUE, breaks = 20, xlab = "f-statistics for sigma 10", ylab = "value", main = "", border = "dodgerblue")
# hist(p_val_10, prob = TRUE, breaks = 20, xlab = "p-value for sigma 10", ylab = "value", main = "", border = "dodgerblue")
# hist(r2_10, prob = TRUE, breaks = 20, xlab = "r squared for sigma 10", ylab = "value", main = "", border = "dodgerblue")
...
Results need to be plotted here.
``` {r}
...
Need to introduce something here
...
train_error_sig1 = c(rmse(train_study2$y, predict(model1, train_study2)),
  rmse(train_study2$y, predict(model2, train_study2)),
  rmse(train_study2$y, predict(model3, train_study2)),
  rmse(train_study2$y, predict(model4, train_study2)),
  rmse(train_study2$y, predict(model5, train_study2)),
  rmse(train_study2$y, predict(model6, train_study2)),
  rmse(train_study2$y, predict(model7, train_study2)),
  rmse(train_study2$y, predict(model8, train_study2)),
  rmse(train_study2$y, predict(model9, train_study2)))

test_error_sig1 = c(rmse(test_study2$y, predict(model1, test_study2)),
  rmse(test_study2$y, predict(model2, test_study2)),
  rmse(test_study2$y, predict(model3, test_study2)),
  rmse(test_study2$y, predict(model4, test_study2)),
  rmse(test_study2$y, predict(model5, test_study2)),
  rmse(test_study2$y, predict(model6, test_study2)),
  rmse(test_study2$y, predict(model7, test_study2)),
  rmse(test_study2$y, predict(model8, test_study2)),
  rmse(test_study2$y, predict(model9, test_study2)))

# study2_models = c("model1", "model2", "model3", "model4", "model5", "model6", "model7", "model8", "model9")
# study2_results = data.frame(study2_models, train_error_sig1, test_error_sig1)
# colnames(study2_results) = c("Model", "Train RMSE", "Test RMSE")
# knitr::kable(study2_results)
...
train_error_sig2 = c(rmse(train_study2$y, predict(model1, train_study2)),
  rmse(train_study2$y, predict(model2, train_study2)),
  rmse(train_study2$y, predict(model3, train_study2)),
  rmse(train_study2$y, predict(model4, train_study2)),
  rmse(train_study2$y, predict(model5, train_study2)),
...
test_error_sig2 = c(rmse(test_study2$y, predict(model1, test_study2)),
  rmse(test_study2$y, predict(model2, test_study2)),
  rmse(test_study2$y, predict(model3, test_study2)),
  rmse(test_study2$y, predict(model4, test_study2)),
  rmse(test_study2$y, predict(model5, test_study2)),
...
train_error_sig4 = c(rmse(train_study2$y, predict(model1, train_study2)),
  rmse(train_study2$y, predict(model2, train_study2)),
  rmse(train_study2$y, predict(model3, train_study2)),
  rmse(train_study2$y, predict(model4, train_study2)),
  rmse(train_study2$y, predict(model5, train_study2)),
...
test_error_sig4 = c(rmse(test_study2$y, predict(model1, test_study2)),
  rmse(test_study2$y, predict(model2, test_study2)),
  rmse(test_study2$y, predict(model3, test_study2)),
  rmse(test_study2$y, predict(model4, test_study2)),
  rmse(test_study2$y, predict(model5, test_study2)),
...
Results need to plotted here. Model 6 should be good ideally.

``` {r }

study2_models = c("Model1", "Model2", "Model3", "Model4", "Model5", "Model6", "Model7", "Model8", "Model9")
study2_results = data.frame(study2_models, train_error_sig1, test_error_sig1, train_error_sig2, test_error_sig2, train_error_sig4, test_error_sig4)
colnames(study2_results) = c("Model", "Train RMSE Sigma(1)", "Test RMSE Sigma(1)", "Train RMSE Sigma(2)", "Test RMSE Sigma(2)", "Train RMSE Sigma(4)", "Test RMSE Sigma(4)")
knitr::kable(study2_results)
...
p_value = rep(0, 1000) #1000 reps

#every beta1 has a p_value
beta_pvalue = list(beta1, p_value)

# for every beta1 value
#  for every simulations num_sims
eps = rnorm(n, mean = 0, sd = sig)
y_values = beta0 + beta1 * x_values + eps #41 in size
n
length(eps)
length(x_values)
length(y_values)
